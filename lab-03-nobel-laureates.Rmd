...
***There are `r nrow(nobel)` and `r ncol(nobel)` colums in the nobel dataset. Each row represents a nobel winner.***
...
***There were 123 winners born in the US.***
...
***From what I can see, the data appears to be similar, but I dont think buzzfeeds is entirely accurate compared to the one below.***
...
```
***Germany is the most common with 20 followed closely by Japan and the UK***
